...
function ECECUT() {
  const facultades = [
    ...
    },
    {
      ...
      emoji: "🏅",
      descripcion:
        "Que demuestren conocimientos, habilidades y actitudes necesarias",
      color: "#1565C0",
    },
    {
  ...
  return (
    <>
      <div className="banner-container-ececut">
        <img src={bannerECECUT} alt="Banner ECECUT" className="banner-ececut" />
      </div>
        ...
        <div className="section-acreditacion">
          <div className="acreditacion-card">
            ...
            <p className="acreditacion-texto">
              Es el área acreditada por el <strong>CONOCER</strong>, bajo la
              rectoría de la{" "}
              <strong>Secretaría de Educación Pública (SEP)</strong>, que tiene
              la facultad de:
            </p>
          </div>
        </div>
          ...
          <div className="facultades-grid">
            {facultades.map((facultad, index) => (
              <div
                ...
                style={
                  { "--facultad-color": facultad.color } as React.CSSProperties
                }
              >
          ...
          <div className="descripcion-contenedor">
            <div className="descripcion-texto">
              <p className="descripcion-parrafo">
                El <strong>ECECUT</strong> evalúa y certifica oficialmente las
                competencias laborales de estudiantes, egresados, docentes,
                fuerza laboral de los sectores productivos, del sector
                gubernamental y social,{" "}
                <span className="texto-destacado">
                  fortaleciendo su perfil profesional
                </span>{" "}
        ...
        <div className="section-certificados" id="Educacion">
          <div className="certificados-card">
            ...
            <div className="certificados-contenido">
              <h3 className="certificados-titulo">
                Certificados con validez oficial
              </h3>
              <p className="certificados-texto">
                Nuestros certificados cuentan con{" "}
                <strong>reconocimiento oficial en todo el país</strong>,
          ...
          <div className="proceso-steps-ececut">
            <div className="step-item">
              ...
              <div className="step-contenido">
                ...
                <p className="step-descripcion">
                  Se evalúan tus conocimientos, habilidades y actitudes
                </p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-contenido">
                ...
                <p className="step-descripcion">
                  Demuestras tu competencia laboral
                </p>
              </div>
            </div>
            <div className="step-connector"></div>
            <div className="step-item">
              ...
              <div className="step-contenido">
                ...
                <p className="step-descripcion">
                  Recibes tu certificado con validez oficial
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="contacto-card">
            ...
            <div className="contacto-item">
              ...
              <div className="contacto-item-contenido">
                ...
                <a
                  href="mailto:ececutut@utnay.edu.mx"
        ...
        <div className="section-cta-ececut">
          <div className="cta-content-ececut">
            ...
            <p className="cta-descripcion">
              Obtén un certificado con validez oficial que respalde tu
