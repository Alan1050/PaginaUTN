  ...
  const programasEgresados = [
    {
      titulo: 'Diplomados',
      emoji: '📜',
      descripcion: 'Programas de actualización profesional a precio preferencial para egresados',
      color: '#2E7D32'
    },
    {
    ...
    },
    {
      ...
      emoji: '🌎',
      descripcion: 'Cursos de inglés con tarifas especiales para nuestra comunidad de egresados',
      color: '#B76E1E'
    }
  ];
  ...
  const oportunidadesEgresados = [
    {
      ...
      emoji: '🎤',
      descripcion: 'Comparte tu experiencia profesional a través de conferencias y talleres',
      color: '#2E7D32'
    },
    {
      titulo: 'Bolsa de Trabajo',
      emoji: '💼',
      descripcion: 'Acceso a oportunidades laborales y vinculación con empresas',
      color: '#1565C0'
    },
    {
      titulo: 'Red de Egresados',
      emoji: '🤝',
      descripcion: 'Forma parte de nuestra comunidad y amplía tu red de contactos profesionales',
      color: '#B76E1E'
    }
  ];
  ...
  const beneficios = [
    {
      ...
      emoji: '💰',
      descripcion: 'Tarifas especiales en diplomados, certificaciones y cursos de inglés'
    },
    {
      beneficio: 'Desarrollo profesional',
      emoji: '📈',
      descripcion: 'Fortalecimiento de competencias para mejorar tu perfil laboral'
    },
    {
      beneficio: 'Vinculación empresarial',
      emoji: '🏢',
      descripcion: 'Conexión directa con empresas a través de nuestra bolsa de trabajo'
    },
    {
      ...
      <section className="content-egresados">
          ...
          <div className="introduccion-card-egresados">
            <div className="introduccion-header-egresados">
              ...
              <div className="introduccion-titulo-wrapper-egresados">
                <h2 className="introduccion-titulo-egresados">Comunidad de Egresados UT Nayarit</h2>
            ...
            <p className="introduccion-texto-egresados">
              Seguimos acompañando a nuestros egresados en su <strong>crecimiento profesional</strong>. 
              A través de nuestros programas, ofrecemos diplomados, certificaciones y cursos de inglés 
              a <strong>precio preferencial</strong>, diseñados para fortalecer sus competencias y mejorar 
              su perfil laboral.
            </p>
          </div>
        </div>
        ...
        <div className="section-programas-egresados">
          <div className="section-header-egresados">
            ...
            <p className="section-subtitle-egresados">
              Fortalece tus competencias con nuestros programas a precio preferencial
            </p>
          ...
          <div className="programas-grid-egresados">
            {programasEgresados.map((programa, index) => (
              <div 
                ...
                style={{ '--programa-color': programa.color } as React.CSSProperties}
              >
                <div className="programa-icono-egresados">
                  <span className="programa-emoji-egresados">{programa.emoji}</span>
                </div>
                <h3 className="programa-titulo-egresados">{programa.titulo}</h3>
                <p className="programa-descripcion-egresados">{programa.descripcion}</p>
          ...
          <div className="oportunidades-grid-egresados">
            {oportunidadesEgresados.map((oportunidad, index) => (
              <div 
                ...
                style={{ '--oportunidad-color': oportunidad.color } as React.CSSProperties}
              >
                <div className="oportunidad-icono-egresados">
                  <span className="oportunidad-emoji-egresados">{oportunidad.emoji}</span>
                </div>
                <h3 className="oportunidad-titulo-egresados">{oportunidad.titulo}</h3>
                <p className="oportunidad-descripcion-egresados">{oportunidad.descripcion}</p>
            ...
            {beneficios.map((beneficio, index) => (
              <div key={index} className="beneficio-card-egresados">
                <div className="beneficio-icono-egresados">
                  <span className="beneficio-emoji-egresados">{beneficio.emoji}</span>
                </div>
                <div className="beneficio-contenido-egresados">
                  <h3 className="beneficio-titulo-egresados">{beneficio.beneficio}</h3>
                  <p className="beneficio-descripcion-egresados">{beneficio.descripcion}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mensaje-card-egresados">
            <div className="mensaje-contenido-egresados">
              ...
              <p className="mensaje-texto-egresados">
                En la <strong>UTNAY</strong>, nuestros egresados continúan siendo parte fundamental 
        ...
        <div className="section-contacto-egresados">
          <div className="contacto-card-egresados">
            ...
            <h3 className="contacto-titulo-egresados">Información y contacto</h3>
            ...
            <div className="contacto-items-egresados">
              <div className="contacto-item-egresados">
                ...
                <div className="contacto-item-contenido">
                  ...
                  <a href="mailto:seguimiento@utnay.edu.mx" className="contacto-email-egresados">
              ...
              <div className="contacto-item-egresados">
                ...
                <div className="contacto-item-contenido">
                  ...
                  <a href="https://wa.me/523114469297" className="contacto-whatsapp-egresados">
                    +52 (311) 446 9297
                  </a>
                </div>
              </div>
        ...
        <div className="section-cta-egresados">
          <div className="cta-content-egresados">
            <h3 className="cta-titulo-egresados">Sigue formando parte de la UT Nayarit</h3>
            ...
            <div className="cta-botones-egresados">
              <a href="mailto:seguimiento@utnay.edu.mx" className="cta-button-egresados cta-button-programas">
                <span>Conocer programas</span>
              </a>
              <a href="https://wa.me/523114469297" className="cta-button-egresados cta-button-whatsapp">
